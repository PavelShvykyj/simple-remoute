...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButtons, IonBackButton, IonNavLink, IonButton, IonAvatar, IonFooter, IonIcon } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonIcon, IonFooter, IonAvatar, IonButton, IonNavLink, IonBackButton, IonButtons, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
